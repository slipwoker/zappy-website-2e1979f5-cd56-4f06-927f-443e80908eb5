document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const phoneInput = contactForm.querySelector('[name="phone"], #phone');
            ...
            if (isValid) {
                ...
                .then(function() {
                    ...
                    successMsg.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; text-align: center;';
                ...
                .catch(function() {
                    ...
                    errorMsg.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; text-align: center;';
                    
                    const existingGlobalError = contactForm.querySelector('.form-global-error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2e1979f5-cd56-4f06-927f-443e80908eb5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2e1979f5-cd56-4f06-927f-443e80908eb5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2e1979f5-cd56-4f06-927f-443e80908eb5';
